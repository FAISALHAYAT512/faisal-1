...
export const metadata: Metadata = {
  title: "Faisal Hayat",
  description:
    "Learn about Faisal Hayat, AI automation expert from Pakistan specializing in RAG systems, intelligent agents, and workflow automation.",
}
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex justify-center space-x-6">
              <Link
                href="mailto:faisalhayath98@gmail.com"
              ...
              <Link
                href="https://github.com/FAISALHAYAT512"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
              >
